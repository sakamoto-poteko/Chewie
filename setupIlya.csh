...
if(${HOSTNAME} == "ftbftracker02.fnal.gov") then
  ...
  setenv CHEWIEDATADIR		   ${BASEDATADIR}/MonicelliOutputIlya
  setenv CHEWIEINPUTDIR            ${BASEDATADIR}/ChewieInputIlya
  setenv CHEWIEOUTPUTDIR           ${BASEDATADIR}/ChewieOutputIlya
